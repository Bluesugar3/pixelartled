...
def classify_static(r: float) -> int:
	"""Static classification using adjustable thresholds (env: T_OPEN/T_HALF/T_LOW)."""
	return 0 if r > T_OPEN else 1 if r > T_HALF else 2 if r > T_LOW else 3
